...
// Note: Uncomment the following for integration tests (with puppeteer that is a mess, will use something else later):
...
// This is the version for unit tests/no puppeteer.
// jest.config.js
import { TextEncoder, TextDecoder } from 'util';

// Note: Uncomment the following for integration tests:
